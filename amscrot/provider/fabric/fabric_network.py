...
from amscrot.policy.policy_helper import get_stitch_port_for_provider
...
class NetworkBuilder:
    ...
    def handle_facility_port(self, *, sites):
        ...
        if len(devices) != len(self.stitch_infos):
            from amscrot.policy.facility_port_handler import load_facility_info_using_stich_port
