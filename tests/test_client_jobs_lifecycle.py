...
import unittest
import pytest
from amscrot.client import Client, Session, Job, JobType, JobServiceType, ServiceClient
...
class TestClientJobsLifecycle(unittest.TestCase):
    def test_jobs_lifecycle(self):
        ...
        sc1 = ServiceClient(name="nersc_perlmutter", endpoint_uri="https://nersc.gov/api")
        sc2 = ServiceClient(name="anl_theta", endpoint_uri="https://anl.gov/api")
