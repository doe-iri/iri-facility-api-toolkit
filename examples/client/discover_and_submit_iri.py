"""
Auto-Discover and Submit Jobs to Discovered Facilities via Session
==================================================================
...
def setup_and_submit(client, session, args):
...
def main():
    parser = argparse.ArgumentParser(description="Submit jobs to discovered IRI facilities via Session.")
    ...
    session = client.create_session("discover-and-submit-session")
    ...
    if session.jobs:
        ...
        setup_and_submit(client, session, args)
